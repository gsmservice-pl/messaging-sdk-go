...
func newCommon(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Common {
	return &Common{
		rootSDK:          rootSDK,
...
func (s *Common) Ping(ctx context.Context, opts ...operations.Option) (*operations.PingResponse, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "4XX", "503", "5XX"}, httpRes.StatusCode) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PingResponse
