...
func newOutgoing(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Outgoing {
	return &Outgoing{
		rootSDK:          rootSDK,
		sdkConfiguration: sdkConfig,
		hooks:            hooks,
		Mms:              newMms(rootSDK, sdkConfig, hooks),
		Sms:              newSms(rootSDK, sdkConfig, hooks),
	}
}
